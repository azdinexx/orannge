      ...
      <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
        ...
        <div className='lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center'>
          <h1 className='title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900'>
            Orannge Tv - Watch Unlimited Streams
          </h1>
          ...
          <div className='flex w-full md:justify-start justify-center items-end'>
            <div className='relative mr-4 lg:w-full xl:w-1/2 w-2/4'>
              ...
              <input
                ...
                id='hero-field'
                name='hero-field'
                className='w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:ring-orange-200 focus:bg-transparent focus:border-orange-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'
              />
            </div>
